...
class TraitUseSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $classPointer): void
    {
        ...
        $this->checkLinesAfterLastUseReflectingConstants($phpcsFile, $usePointers[count($usePointers) - 1]);
    ...
    private function checkLinesAfterLastUseReflectingConstants(File $phpcsFile, int $lastUsePointer): void
    {
        $tokens = $phpcsFile->getTokens();
        ...
        if ($tokens[$pointerAfterLastUse]['code'] === T_CONST || $tokens[$pointerAfterLastUse + 2]['code'] === T_CONST) {
            $requiredLinesCountAfterLastUse = 0;
        }
